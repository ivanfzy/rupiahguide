...
## Why planning cash for a week (not daily) matters
...
- **Luxury traveler:** $200 USD/day (Rp3.300.000/day)

For planning, round to nearest Rp50.000 for simplicity:
- Budget: Rp800.000/day
- Mid-range: Rp1.650.000/day
- Luxury: Rp3.300.000/day

## Step 2: Account for Variable Costs
...
| Day | Activity | Daily Budget | Notes |
|---|---|---|---|
| Day 1 | Arrival + explore | Rp1.650.000 | Normal budget traveler day |
| Day 2 | Beach day (free) | Rp1.450.000 | Save Rp200.000 (no activities, simple food) |
| Day 3 | Paid tour | Rp2.300.000 | Add Rp650.000 for tour |
| Day 4 | Spa + nice dinner | Rp2.000.000 | Add Rp350.000 for spa + upscale meal |
| Day 5 | Rest day | Rp1.200.000 | Save Rp450.000 (minimal movement, cheap food) |
| Day 6 | Cooking class + shopping | Rp2.450.000 | Add Rp800.000 (cooking class + souvenir budget) |
| Day 7 | Departure | Rp800.000 | Only breakfast + minimal activity |
| **WEEK TOTAL** | | **Rp11.850.000** | **~$718 USD** |

## Step 3: Calculate Total Weekly Cash Need

**Simple formula:**

```
(Daily budget × 7 days) + Activity surcharges - Budget savings = Weekly cash needed
```

**Using the example above:**

```
(Rp1.650.000 × 7) + [Rp650.000 + Rp350.000 + Rp800.000] - [Rp200.000 + Rp450.000]
= Rp11.550.000 + Rp1.800.000 - Rp650.000
= Rp12.700.000
```

Round to Rp12.700.000 for convenience.

## Step 4: Add Safety Buffer (10–15%)

Never plan your cash to exactly zero—unexpected expenses always happen.

```
Weekly total × 1.10 (for 10% buffer) = Final amount to withdraw
```

**Using the example:**

```
Rp12.700.000 × 1.10 = Rp13.970.000
```

Round to Rp14.000.000 for easy mental math.
...
- Rp50.000 × 15 notes = Rp750.000
- Rp20.000 × 10 notes = Rp200.000
- Rp10.000 × 10 notes = Rp100.000
- Rest in appropriate denominations

## Real-World Example: 7-Day Trip Planning

### Scenario: Mid-Range Traveler, 1 Week
...
### Multi-City Trip (7 Days Across 3 Cities)

When you're moving between cities, plan cash per city:

**City 1 (3 days): Rp4.500.000**
- Daily base: Rp1.500.000 × 3 = Rp4.500.000
- No activities (exploring only)

**City 2 (2 days): Rp3.800.000**
- Daily base: Rp1.500.000 × 2 = Rp3.000.000
- Paid tour: Rp800.000
- Total: Rp3.800.000

**City 3 (2 days): Rp3.300.000**
- Daily base: Rp1.500.000 × 2 = Rp3.000.000
- Departure day (less spending): Rp300.000
...
**Mistake #1: Forgetting accommodation in your budget**
- This article assumes accommodation is pre-booked separately
...
**Mistake #3: Assuming consistent daily spending**
- Real weeks have high-spend days and low-spend days
- Don't use a flat average—account for variation

**Mistake #4: Not including transport between cities**
- If traveling to other cities, add:
  - Flight: Rp500.000–2.000.000 (if booked in-country)
  - Bus: Rp100.000–500.000
  - Train: Rp100.000–300.000
- These can swing your weekly budget significantly

**Mistake #5: Withdrawing too much and then overspending**
- Carrying Rp30.000.000 makes you feel rich—and you'll spend like it
- Stick to your planned amount; carry only what you calculated

## The Math-Free Shortcut

If all this math feels tedious, here's a simple rule:

```
(Daily budget × 7) + Rp2.000.000 (for activities) + 10% buffer
```

**Using this shortcut:**

- Budget traveler: (Rp800.000 × 7) + Rp2.000.000 + 10% = Rp7.980.000 → round to **Rp8.000.000**
- Mid-range: (Rp1.650.000 × 7) + Rp2.000.000 + 10% = **Rp14.465.000** → round to **Rp14.500.000**
- Luxury: (Rp3.300.000 × 7) + Rp2.000.000 + 10% = **Rp27.730.000** → round to **Rp28.000.000**

This covers baseline + moderate activities + buffer. If you plan heavy activity weeks, add another Rp2.000.000–5.000.000.
